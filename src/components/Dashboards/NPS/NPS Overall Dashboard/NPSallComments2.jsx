              ...
              <div>
                <div className="text-[12px] p-3 pb-0 w-full  ">
                  <div className="border-b-gray-100 border-b-2 sticky bg-white top-0 z-[5] ">
                    <div className=" grid grid-cols-[60px_minmax(200px,1fr)_150px_80px] gap-2  border-b  text-[12px] text-gray-500 uppercase font-normal">
                      <div
                      ...
                      >
                        <div
                          className=" cursor-pointer hover:text-gray-600 transition-all  inline-block w-full h-full   text-center"
                          ...
                          rowRenderer={({ key, index, style, parent }) => {
                            ...
                            return (
                              ...
                              >
                                <div
                                  style={style}
                                  className=" grid grid-cols-[60px_minmax(200px,1fr)_150px_80px] gap-2 items-center  border-b py-2 "
                                >
                                  <div className="  text-gray-400  capitalize  font-normal text-[12px]  ">
                                    {data?.timestamp}
                                  </div>
                                  <div
                                    className={`   h-auto text-[#000c08b3] font-semibold   text-left   `}
                                  >
                                    {data?.review}
                                    {/* <div
                      ...
                      .map((data, index) => {
                        return (
                          <div key={index} className="w-full ">
                            <>
                              <div className=" grid grid-cols-[60px_minmax(200px,1fr)_150px_80px] items-center  border-b py-2 min-h-[60px]">
                                <div className="  text-gray-400  capitalize  font-normal text-[12px]  ">
                                  {data?.timestamp}
                                </div>
                ...
                {/* <div className=" flex  justify-center items-center p-2">
                  <div className="flex flex-col justify-center items-center cursor-pointer ">
                    ...
                    <div className="text-xs text-gray-500">This is the end</div>
                  </div>
                </div> */}
              </div>
            )}
...
export default NPSallComments2;
